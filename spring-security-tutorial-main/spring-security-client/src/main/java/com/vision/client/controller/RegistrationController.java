package com.vision.client.controller;
...
import com.vision.client.model.PasswordModel;
...
public class RegistrationController {
    ...
    private String resendVerificationTokenMail(User user, String applicationUrl, VerificationToken verificationToken) {
        String url =applicationUrl.concat("/verifyRegistration?token=").concat(verificationToken.getToken());
         //sendVerificationEmail()
